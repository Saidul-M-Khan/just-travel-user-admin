    ...
    <section class="home-section">
      ...
      <div>
        ...
        <div class="container">
          ...
          <input type="text" id="search" placeholder="offer_name">
          ...
          <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) { ?>
              ...
              <tr>
                ...
                <td><?php echo $row['offer_summary']; ?></td>
                <td><?php echo $row['offer_details']; ?></td>
                <td><?php echo $row['offer_rules']; ?></td>
                <td><?php echo $row['status']; ?></td>
                <td>
                  <div class="button"><a href="./edit/offer/editoffer.php?id=<?php echo $row['offer_id']; ?>"> EDIT </a></div>
                </td>
                <td>
                  <div class="button"><a href="./edit/offer/deleteoffer.php?id=<?php echo $row['offer_id']; ?>"> Delete </a></div>
                </td>
              </tr>
