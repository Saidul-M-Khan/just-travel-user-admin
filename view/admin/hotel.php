          ...
          <tbody>
            ...
            ?>
                ...
                <tr>
                  ...
                  <td>
                    <div class="button"><a href="./edit/hotel/edithotel.php?id=<?php echo $row['hotel_id']; ?>"> EDIT </a></div>
                  </td>
                  <td>
                    <div class="button"><a href="./edit/hotel/deletehotel.php?id=<?php echo $row['hotel_id']; ?>"> Delete </a></div>
                  </td>
                </tr>
