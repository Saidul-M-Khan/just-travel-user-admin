...
?>
  ...
  <body>
    ...
    <section class="home-section">
      <div class="text">Launch Tickets</div>
      <!-- after head -->
      ...
      <div>
        ...
        <div class="container">
          ...
          <input type="text" id="search" placeholder="launch_route">
        ...
        <table class="fl-table">
          ...
          <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) { ?>
              ...
              <tr>
                <td><?php echo $row['launch_ticket_id']; ?></td>
                <td><?php echo $row['launch_operator_name']; ?></td>
                <td><?php echo $row['launch_route']; ?></td>
                <td><?php echo $row['launch_deck_type']; ?></td>
                <td><?php echo $row['launch_journey_date']; ?></td>
                <td><?php echo $row['launch_ticket_price']; ?></td>
                <td><?php echo $row['launch_ticket_availability']; ?></td>
                <td><?php echo $row['launch_available_seats']; ?></td>
                <td><?php echo $row['launch_starting_location']; ?></td>
                <td><?php echo $row['launch_ending_location']; ?></td>
                <td><?php echo $row['launch_arrival_time']; ?></td>
                <td><?php echo $row['launch_departure_time']; ?></td>
                <td><img src="<?php echo $row['image']; ?>" alt="image" style="width:100px;height:100px;"> </td>
                <td><?php echo $row['status']; ?></td>
                <td>
                  <div class="button"><a href="./edit/lonch/editlon.php?id=<?php echo $row['launch_ticket_id']; ?>"> EDIT </a></div>
                </td>
                <td>
                  <div class="button"><a href="./edit/lonch/deletelon.php?id=<?php echo $row['launch_ticket_id']; ?>"> Delete </a></div>
                </td>
              </tr>
