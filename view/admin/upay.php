            ...
            <tbody>
              ...
              while ($row = mysqli_fetch_assoc($result)) { ?>
                ...
                <tr>
                  ...
                  <td>
                    <div class="button"><a href="./edit/upay/editupay.php?id=<?php echo $row['id']; ?>"> EDIT </a></div>
                  </td>
                  <td>
                    <div class="button"><a href="./edit/upay/deleteupay.php?id=<?php echo $row['id']; ?>"> Delete </a></div>
                  </td>
                </tr>
