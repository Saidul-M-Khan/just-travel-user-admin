    ...
    <section class="home-section">
      ...
      <div>
        ...
        <div class="container">
          ...
          <input type="text" id="search" placeholder="Route">
        ...
        <table class="fl-table">
          ...
          <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) { ?>
              ...
              <tr>
                <td><?php echo $row['air_ticket_id']; ?></td>
                <td><?php echo $row['airline_name']; ?></td>
                <td><img src="<?php echo $row['airline_image']; ?>" alt="image" style="width:50px;height:50px;"> </td>
                <td><?php echo $row['flight_no']; ?></td>
                <td><?php echo $row['air_ticket_type']; ?></td>
                <td><?php echo $row['air_ticket_price']; ?></td>
                <td><?php echo $row['plane_route']; ?></td>
                <td><?php echo $row['plane_journey_date']; ?></td>
                <td><?php echo $row['plane_ticket_availability']; ?></td>
                <td><?php echo $row['plane_available_seat']; ?></td>
                <td><?php echo $row['plane_start_location']; ?></td>
                <td><?php echo $row['plane_end_location']; ?></td>
                <td><?php echo $row['plane_arrival_time']; ?></td>
                <td><?php echo $row['plane_departure_time']; ?></td>
                <td><img src="<?php echo $row['image']; ?>" alt="image" style="width:50px;height:50px;"> </td>
                <td><?php echo $row['status']; ?></td>
                <td>
                  <div class="button"><a href="./edit/air/editair.php?id=<?php echo $row['air_ticket_id']; ?>"> EDIT </a></div>
                </td>
                <td>
                  <div class="button"><a href="./edit/air/deleteair.php?id=<?php echo $row['air_ticket_id']; ?>"> Delete </a></div>
                </td>
              </tr>
