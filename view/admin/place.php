    ...
    <section class="home-section">
      ...
      <div>
        ...
        <div class="container">
          ...
          <input type="text" id="search" placeholder="place_name">
          ...
          <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) { ?>
              ...
              <tr>
                ...
                <td><img src="<?php echo $row['place_image']; ?>" alt="image" style="width:100px;height:100px;"> </td>
                <td>
                  <div class="button"><a href="./edit/place/editplace.php?id=<?php echo $row['place_id']; ?>"> EDIT </a></div>
                </td>
                <td>
                  <div class="button"><a href="./edit/place/deleteplace.php?id=<?php echo $row['place_id']; ?>"> Delete </a></div>
                </td>
              </tr>
