        ...
        while ($row = mysqli_fetch_assoc($result)) { ?>
          ...
          <div class="card">
            <div class="card-container">
              <img src="<?php echo $row['photo']; ?>" alt="photo" style="width:50px;height:50px;">

              <div class="card-data">
                <?php echo "ID: " . $row['id'] . "<br>" . "Role: " . $row['role'] . "<br>" . "User Name: " . $row['username'] . "<br>" . "Email: " . $row['email'] . "<br>" . "Full Name:" . $row['fname'] . " <br><br>"; ?>

                <!-- edit option -->
                <div class="button"><a href="./edit/edituser.php?id=<?php echo $row['id']; ?>"> EDIT </a></div>
                <!-- delete user -->
                <div class="button"><a href="./edit/deleteuser.php?id=<?php echo $row['id']; ?>"> DELETE </a></div>
              </div>
            </div>
          </div>
